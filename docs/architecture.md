...
It refuses a case-variant memory file such as a lowercase `agents.md`, so `AGENTS.md` has the exact name on every filesystem, and surfaces the mismatch for manual reconciliation.
