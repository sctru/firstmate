...
description: Load when a ship reports a ready PR or local branch, when landing is authorized, or before task cleanup.
...
## Merge authority contract extracted from AGENTS.md
...
Load `landing-lifecycle` when a ship reports a ready PR or local branch, when landing is authorized, or before task cleanup.
